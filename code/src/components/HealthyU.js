          ...
          <section>
            ...
            <h3>Features</h3>
              ...
              <ol>
                ...
                <li>Touch based, interactive application.</li>
                <li>Interactive body diagram.</li>
                <li>Interactive mascot designed to help struggling users navigate through the application.</li>
                <li>Be able to print blogs.</li>
                <li>Form to add/remove more posts.</li>
                <li>Likes on content to recommend/get anonymous feedback.</li>
